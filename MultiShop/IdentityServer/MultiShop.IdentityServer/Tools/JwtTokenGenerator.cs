...
namespace MultiShop.IdentityServer.Tools
{
    ...
    {
        public static TokenResponseViewModel GenerateToken(GetCheckAppUserViewModel model) //jwt token oluşturucu
        {
            ...
            JwtSecurityToken token = new JwtSecurityToken(issuer: JwtTokenDefault.ValidIssuer,
                audience: JwtTokenDefault.ValidAudiance, claims: claims, notBefore: DateTime.UtcNow,
